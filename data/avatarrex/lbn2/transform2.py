...
# # 输入路径
# input_root = "/mnt/ssd2tB/haocheng/AnimatableGaussians/data/avatarrex/lbn2"

# # 输出路径
# output_root = "/mnt/ssd2tC/hctang/GPS-Gaussian/new_avatarrex_lbn2"
...
# 输入路径（output 文件夹）
input_dir = "/mnt/ssd2tB/haocheng/AnimatableGaussians/data/avatarrex/lbn2/output"

# 输出路径（parm 文件夹）
output_root = "/mnt/ssd2tC/hctang/GPS-Gaussian/new_avatarrex_lbn2/parm"
