...
# # 输入路径
# input_root = "/mnt/ssd2tB/haocheng/AnimatableGaussians/data/avatarrex/lbn1"

# # 输出路径
# output_root = "/mnt/ssd2tC/hctang/GPS-Gaussian/new_avatarrex_lbn1"
...
#         camera_dir = os.path.join(input_root, camera_id)

#         # 图片路径
#         img_path = os.path.join(camera_dir, f"{frame:08d}.jpg")
#         # mask 路径
#         mask_path = os.path.join(camera_dir, "mask", "pha", f"{frame:08d}.jpg")
...
# 输入路径（output 文件夹）
input_dir = "/mnt/ssd2tB/haocheng/AnimatableGaussians/data/avatarrex/lbn1/output"

# 输出路径（parm 文件夹）
output_root = "/mnt/ssd2tC/hctang/GPS-Gaussian/new_avatarrex_lbn1/parm"
