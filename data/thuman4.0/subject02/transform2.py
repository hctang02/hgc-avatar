...
# # 输入路径
# input_root = "/mnt/ssd2tB/haocheng/AnimatableGaussians/data/thuman4.0/subject02"

# # 输出路径
# output_root = "/mnt/ssd2tC/hctang/GPS-Gaussian/new_thuman_sub02"
...
# 输入路径（output 文件夹）
input_dir = "/mnt/ssd2tB/haocheng/AnimatableGaussians/data/thuman4.0/subject02/output"

# 输出路径（parm 文件夹）
output_root = "/mnt/ssd2tC/hctang/GPS-Gaussian/new_thuman_sub02/parm"
