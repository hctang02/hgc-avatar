...
2026-08-13 进一步完成了 4 人物 × 4 量化层级的 16 点实测（每人物 500 帧）：

| q | 四人物平均完整成本 | 平均参考 PSNR | 平均参考 SSIM |
|---:|---:|---:|---:|
| 4 | 1061.09 KiB/帧 | 37.060 dB | 0.992931 |
| 5 | 701.45 KiB/帧 | 36.855 dB | 0.992733 |
| 6 | 626.54 KiB/帧 | 34.242 dB | 0.988200 |
| 7 | 500.17 KiB/帧 | 25.223 dB | 0.952903 |

`q=5` 相比 `q=4` 平均完整成本下降约 33.9%，平均参考 PSNR 仅下降约 0.21 dB，是当前推荐默认档；`q=7` 出现明显质量下降，仅建议用于快速预览或极限压缩消融。完整数据和 Word 报告见 [`docs/reports/`](docs/reports/)。
