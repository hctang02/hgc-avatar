...
0. Clone this repo.
```
git clone https://github.com/hctang02/hgc-avatar.git
# or
git clone git@github.com:hctang02/hgc-avatar.git
```

Large datasets, pretrained weights, licensed SMPL-X models, compiled binaries,
and experiment outputs are intentionally not tracked. Download the required
assets using the instructions below and build the native extensions locally.
